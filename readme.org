...
* Todo
  ...
  4. Incluir la "negacion" de constructores

  5. Pruebas de rendimiento

  6. Hacer un poco mas "funcional" algunas funciones

  7. Paralelizar la busqueda de rutas
