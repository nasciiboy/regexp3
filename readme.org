...
regexp3 (*C-lang*): [[https://github.com/nasciiboy/RecursiveRegexpRaptor][here]]
regexp4 (*C-lang*): [[https://github.com/nasciiboy/RecursiveRegexpRaptor-4][here]]
...
* Todo
  ...
  many thing will change in the short term (other when learning to oop and the
  rest when learning to parallelize things)

  1. Refactor

  2. Number of catches dynamic

  3. Adding utf-8 character support

  4. Tests of performance

  5. Make a few functions more "functional"

  6. Parallelize the search of routes
